...
import { ArrowRight, Github, Linkedin, Mail, Code, Database, Zap, Users, Target, TrendingUp, ExternalLink, ChevronDown, Trophy, Award, Briefcase, GraduationCap, Twitter, Crown, Star, Menu, X, Rocket, Globe, CloudLightning as Lightning } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Button 
                onClick={() => window.open('https://twitter.com/gooodnesmbakara', '_blank')}
              ...
              <StaggeredReveal staggerDelay={150} direction="up">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2 text-emerald-400">
                    ...
                    <span className="text-lg font-semibold">Computer Science Graduate</span>
                  </div>
                </div>

                <p className="text-lg text-gray-400 leading-relaxed max-w-2xl">
                  Dynamic backend engineer and proven team leader with track record of managing 30+ engineers and building scalable solutions. 
                  Computer Science graduate specializing in Django, FastAPI, blockchain development (Solidity, EVM, Solana), and cloud infrastructure.
                </p>
                ...
                <div className="flex items-center space-x-6 pt-4">
                  <a href="https://github.com/Goodnessmbakara" className="text-gray-400 hover:text-emerald-400 transition-colors">
                    <Github className="w-6 h-6" />
                  </a>
                  <a href="https://linkedin.com/in/goodnessmbakara/" className="text-gray-400 hover:text-emerald-400 transition-colors">
                    <Linkedin className="w-6 h-6" />
                  </a>
                  <a href="https://twitter.com/gooodnesmbakara" className="text-gray-400 hover:text-emerald-400 transition-colors">
                    <Twitter className="w-6 h-6" />
                  </a>
                  <a href="mailto:mbakaragoodness2003@gmail.com" className="text-gray-400 hover:text-emerald-400 transition-colors">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-300 text-lg leading-relaxed">
                    I am a dynamic initiator with a proven track record of effectively managing teams and tackling challenging tasks. 
                    As an accomplished backend and blockchain developer, I possess exceptional interpersonal abilities and unwavering dedication to my craft.
                  </p>
                  <p className="text-gray-300 text-lg leading-relaxed mt-4">
                    My focus is on achieving tangible results while fostering collaboration within the team. I have an innate drive to see every project through until completion, 
                    with experience leading teams of over 30 engineers across UI/UX, Frontend, and Backend tracks. I specialize in blockchain development with expertise in Solidity, EVM, and Solana ecosystems.
                  </p>
                </div>
                ...
                <StaggeredReveal staggerDelay={200} direction="up">
                  <Card className="bg-slate-800/50 border-emerald-500/20">
                    <CardContent className="p-6 text-center">
                      ...
                      <div className="text-2xl font-bold text-emerald-400">4X</div>
                ...
                <StaggeredReveal staggerDelay={150} direction="up">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-emerald-400 text-sm">2021 - 2024</span>
                      </div>
                      <p className="text-gray-400">University of Uyo, Nigeria</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-400">Google Developer Student Clubs</p>
                      <ul className="text-gray-300 text-sm mt-2 space-y-1">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="text-lg font-semibold text-white">ALX Backend Engineering</h4>
                        <span className="text-purple-400 text-sm">2022 - 2023</span>
                      </div>
          ...
          <ScrollReveal direction="up" duration={1000}>
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg max-w-3xl mx-auto">
                Demonstrated ability to lead diverse teams, manage complex projects, and deliver exceptional results under pressure.
              </p>
            </div>
          </ScrollReveal>
          ...
          <StaggeredReveal staggerDelay={200} direction="up">
            <Card className="bg-slate-800/50 border-emerald-500/20 text-center">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Team Leadership</h3>
                <div className="text-3xl font-bold text-emerald-400 mb-2">30+</div>
                <p className="text-gray-400">
                  Engineers successfully led across UI/UX, Frontend, and Backend tracks during HngX internship program.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-cyan-500/20 text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-400">
                  Project completion rate with focus on achieving tangible results and fostering team collaboration.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-purple-500/20 text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-400">
                  Ongoing mentorship through GDSC, teaching Python and guiding emerging developers in their careers.
                </p>
              </CardContent>
            </Card>
          </StaggeredReveal>
      ...
      <section id="experience" className="py-24 bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <StaggeredReveal staggerDelay={300} direction="up">
            <Card className="bg-slate-800/50 border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300">
              <CardContent className="p-8">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2">Backend Engineer</h3>
                    <p className="text-emerald-400 font-semibold">KWEK</p>
                  </div>
                  <span className="text-gray-400 text-sm">Dec 2024 - Feb 2025</span>
                </div>
                <ul className="text-gray-300 space-y-2 mb-6">
                  <li>• Developed and optimized backend APIs for a fast-growing e-commerce platform</li>
                  <li>• Implemented secure authentication and authorization mechanisms using JWT</li>
                  <li>• Improved database performance by designing efficient PostgreSQL schemas</li>
                  <li>• Integrated third-party payment gateways to facilitate seamless transactions</li>
                  <li>• Collaborated with frontend team to ensure smooth API consumption and data consistency</li>
                </ul>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-400">Django</Badge>
                  <Badge variant="secondary" className="bg-cyan-500/10 text-cyan-400">PostgreSQL</Badge>
                  <Badge variant="secondary" className="bg-purple-500/10 text-purple-400">JWT</Badge>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-8">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-cyan-400 font-semibold">ZIDIO Development</p>
                  </div>
                  <span className="text-gray-400 text-sm">Aug 2024 - Nov 2024</span>
                </div>
                <ul className="text-gray-300 space-y-2 mb-6">
                  <li>• Completed intensive Web Development internship working with developers, designers and PMs</li>
                  <li>• Built certificate generation and verification tools, job posting portal</li>
                  <li>• Integrated Socket.IO for live job updates and notifications</li>
                  <li>• Designed and optimized MongoDB schemas for dynamic job listings</li>
                  <li>• Assisted in deploying applications and setting up cloud infrastructure</li>
                </ul>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-400">MongoDB</Badge>
                  <Badge variant="secondary" className="bg-cyan-500/10 text-cyan-400">Socket.IO</Badge>
                  <Badge variant="secondary" className="bg-purple-500/10 text-purple-400">Cloud</Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
              <CardContent className="p-8">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-gray-400 text-sm">Sep 2023 - Oct 2023</span>
                </div>
                <ul className="text-gray-300 space-y-2 mb-6">
                  <li>• <strong>Led a team of over 30 engineers</strong> across UI/UX, Frontend and Backend tracks</li>
                  <li>• Built e-assessment platform as part of zuri-portfolio application</li>
                  <li>• Developed Chrome extension backend for screen recording with video storage</li>
                  <li>• Created event management platform for community and event creation</li>
                  <li>• Implemented weather forecasting system with automated cron job updates</li>
                </ul>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-400">Python</Badge>
                  <Badge variant="secondary" className="bg-cyan-500/10 text-cyan-400">Django REST</Badge>
                  <Badge variant="secondary" className="bg-purple-500/10 text-purple-400">Flask</Badge>
                  <Badge variant="secondary" className="bg-orange-500/10 text-orange-400">Leadership</Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-orange-500/20 hover:border-orange-500/40 transition-all duration-300">
              <CardContent className="p-8">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2">Backend Engineer</h3>
                    <p className="text-orange-400 font-semibold">African Leaders X (ALX)</p>
                  </div>
                  <span className="text-gray-400 text-sm">Jun 2022 - May 2023</span>
                </div>
                <ul className="text-gray-300 space-y-2 mb-6">
                  <li>• Designed and managed databases, including schema creation using drawing tools</li>
                  <li>• Integrated Redis and caching for enhanced data retrieval performance</li>
                  <li>• Utilized SQL and NoSQL database systems to store and manage data efficiently</li>
                  <li>• Implemented various authentication systems including basic, session token, and JWT authentication</li>
                  <li>• Enhanced system security and user access control mechanisms</li>
                </ul>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-400">SQL/NoSQL</Badge>
                  <Badge variant="secondary" className="bg-cyan-500/10 text-cyan-400">Redis</Badge>
                  <Badge variant="secondary" className="bg-purple-500/10 text-purple-400">Authentication</Badge>
                  <Badge variant="secondary" className="bg-orange-500/10 text-orange-400">Database Design</Badge>
                </div>
              </CardContent>
            </Card>
          </StaggeredReveal>
      ...
      <section id="projects" className="py-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute top-40 right-20 w-48 h-48 bg-cyan-500/30 rounded-full blur-2xl animate-float" style={{ animationDelay: '2s' }}></div>
          <div className="absolute bottom-20 left-1/3 w-40 h-40 bg-purple-500/30 rounded-full blur-2xl animate-float" style={{ animationDelay: '4s' }}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <StaggeredReveal staggerDelay={250} direction="up">
            <Card className="bg-slate-800/50 border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-500 group relative overflow-hidden">
              ...
              <CardContent className="p-8 relative z-10">
                ...
                <p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors duration-300">
                  Fast-growing e-commerce platform with optimized APIs, secure authentication, and integrated payment gateways for seamless transactions.
                </p>
                <div className="flex flex-wrap gap-2 mb-6">
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 transition-colors">Django</Badge>
                  <Badge variant="secondary" className="bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 transition-colors">PostgreSQL</Badge>
                  <Badge variant="secondary" className="bg-purple-500/10 text-purple-400 hover:bg-purple-500/20 transition-colors">JWT</Badge>
                </div>
            ...
            <Card className="bg-slate-800/50 border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-40 transition-opacity duration-500">
                <Globe className="w-8 h-8 text-cyan-400 animate-spin" style={{ animationDuration: '4s' }} />
              </div>
              ...
              <CardContent className="p-8 relative z-10">
                ...
                <p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors duration-300">
                  Chrome extension with backend API for screen recording functionality. Users can save and retrieve videos at convenience with secure storage.
                </p>
                <div className="flex flex-wrap gap-2 mb-6">
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 transition-colors">Python</Badge>
                  <Badge variant="secondary" className="bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 transition-colors">Flask</Badge>
                  <Badge variant="secondary" className="bg-purple-500/10 text-purple-400 hover:bg-purple-500/20 transition-colors">Chrome API</Badge>
                </div>
            ...
            <Card className="bg-slate-800/50 border-purple-500/20 hover:border-purple-500/40 transition-all duration-500 group relative overflow-hidden">
              ...
              <CardContent className="p-8 relative z-10">
                ...
                <p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors duration-300">
                  Comprehensive platform where users can create different communities and engaging events with full backend API support and real-time features.
                </p>
                <div className="flex flex-wrap gap-2 mb-6">
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 transition-colors">Django REST</Badge>
                  <Badge variant="secondary" className="bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 transition-colors">PostgreSQL</Badge>
                  <Badge variant="secondary" className="bg-purple-500/10 text-purple-400 hover:bg-purple-500/20 transition-colors">Real-time</Badge>
                </div>
            ...
            <Card className="bg-slate-800/50 border-orange-500/20 hover:border-orange-500/40 transition-all duration-500 group relative overflow-hidden">
              ...
              <CardContent className="p-8 relative z-10">
                ...
                <p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors duration-300">
                  Data scraping and formatting system for weather forecasts with integrated cron job for automated system updates and monitoring.
                </p>
                <div className="flex flex-wrap gap-2 mb-6">
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 transition-colors">Python</Badge>
                  <Badge variant="secondary" className="bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 transition-colors">Cron Jobs</Badge>
                  <Badge variant="secondary" className="bg-purple-500/10 text-purple-400 hover:bg-purple-500/20 transition-colors">Data Scraping</Badge>
                </div>
      ...
      <section id="skills" className="py-24 bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <StaggeredReveal staggerDelay={200} direction="up">
            <div>
              <h3 className="text-2xl font-bold text-emerald-400 mb-8">Backend & Languages</h3>
              <div className="space-y-6">
                {[
            ...
            <div>
              <h3 className="text-2xl font-bold text-cyan-400 mb-8">Blockchain & Web3</h3>
              <div className="space-y-6">
                {[
                  { name: 'Solidity & Smart Contracts', level: 90, color: 'cyan' },
                  { name: 'EVM Development', level: 88, color: 'purple' },
                  { name: 'Solana & Move Language', level: 85, color: 'emerald' },
            ...
            <div>
              <h3 className="text-2xl font-bold text-purple-400 mb-8">DevOps & Tools</h3>
              <div className="space-y-6">
                {[
                  { name: 'Docker & Containerization', level: 87, color: 'purple' },
                  { name: 'AWS Cloud Services', level: 85, color: 'emerald' },
                  { name: 'Git & GitHub', level: 92, color: 'cyan' },
                  { name: 'Linux & Bash Scripting', level: 88, color: 'purple' },
          ...
          <ScrollReveal direction="up" delay={600}>
            <div className="mt-16 text-center">
              <h3 className="text-xl font-bold text-white mb-6">Leadership & Soft Skills</h3>
          ...
          <StaggeredReveal staggerDelay={250} direction="up">
            <Card className="bg-slate-800/50 border-emerald-500/20 text-center">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold text-white mb-4">4X Hackathon Winner</h3>
                <p className="text-gray-400">
                  Consistently delivering innovative solutions under pressure, showcasing technical excellence and creative problem-solving across multiple competitions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-cyan-500/20 text-center">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Team Leadership</h3>
                <p className="text-gray-400">
                  Successfully led teams of 30+ engineers across multiple tracks, fostering collaboration and delivering complex projects on time.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-purple-500/20 text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-400">
                  Computer Science graduate with strong foundation in algorithms, data structures, and software development principles.
                </p>
              </CardContent>
            </Card>
          </StaggeredReveal>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <ScrollReveal direction="left" duration={1000}>
              <div className="space-y-8">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-emerald-400 mb-3">Open to:</h4>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="text-gray-400 text-center md:text-right">
                ...
                <p className="text-sm mt-1">Computer Science Graduate • Backend & Blockchain Engineer • Team Leader</p>
              </div>
            </div>
          </div>
        </footer>
