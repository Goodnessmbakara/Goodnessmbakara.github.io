  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-primary': 'linear-gradient(135deg, #1A237E 0%, #00BFAE 100%)',
        'gradient-accent': 'linear-gradient(135deg, #00BFAE 0%, #673AB7 100%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
